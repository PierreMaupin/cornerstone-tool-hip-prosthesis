 ...
 */
export default function getROITextBoxCoords(viewport: any, handles: any) {
 ...
 */
function _determineCorners(handles: any) {
  ...
  function _compareX(a: any, b: any) {
    return a.x < b.x ? -1 : 1
  }
  function _compareY(a: any, b: any) {
    return a.y < b.y ? -1 : 1
  }
}
